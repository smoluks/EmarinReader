...
#define RAW_RFID_READ_BUFFER_SIZE 16
#define RFID_BUFFER_HANDLER RAW_RFID_READ_BUFFER + RAW_RFID_READ_BUFFER_SIZE
#define RFID_CURRENT_BIT_COUNT RFID_BUFFER_HANDLER+1
#define RFID_TARGET_BIT_COUNT RFID_BUFFER_HANDLER+2
;uart
#define UART_RX_STATE RFID_TARGET_BIT_COUNT + 1
...
#define TCNT0_PROBE_TIME 216 ;probe time 3/4 - 0x100-(RFID_PERIOD_LENGTH*3/4)
#define TCNT0_SKIP_TIME 218 ;skip time 3/4 +- - 0x100-(RFID_PERIOD_LENGTH*3/4)
...
#define CONST_TCCR0 r12
#define CONST_RFID_BUFFER_HANDLER r13
ldi r16, 0b00000011 ;/64
ldi r17, low(RAW_RFID_READ_BUFFER)
movw r12, r16

#define CONST_TOV2_MASK r14
#define CONST_TOV2_CLEAR_PRESCALER r15
ldi r16, 0b01000000
ldi r17, 0b00000010
movw r14, r16
...
#define RFIDFLAGS_DATA_READY 0
#define RFIDFLAGS_READ 1
#define RFIDFLAGS_LOGIN_4305 2
#define RFIDFLAGS_WRITE_4305 3
